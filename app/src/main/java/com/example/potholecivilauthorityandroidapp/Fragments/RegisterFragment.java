...
import com.example.potholecivilauthorityandroidapp.Activities.LoginActivity;
import com.example.potholecivilauthorityandroidapp.Activities.SignupActivity;
import com.example.potholecivilauthorityandroidapp.Helpers.NetworkHelper;
import com.example.potholecivilauthorityandroidapp.Interfaces.AuthApi;
            ...
            public void onClick(View v) {
                ...
                if(!firstname.equals("") && !lastname.equals("") && !email.equals("") && !password.equals("") && !confirmPassword.equals("")){
                    if(password.equals(confirmPassword)){
                        ...
                        Call<ResponseBody> otpCall = authApi.getSignupOtp(new CivilAuthority(email));
